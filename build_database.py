...
SELIA_DIMS_PATH = os.path.join(project_root, "vector_dimensions_custom_ai.json")
LYRA_DIMS_PATH = os.path.join(project_root, "vector_dimensions_custom_ai_lyra.json")

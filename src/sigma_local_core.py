...
if __name__ == '__main__':
    ...
    psyche_log_path = os.path.join(log_dir, "psyche_log.jsonl")

    # Create a dummy psyche log to simulate some activity
    if not os.path.exists(psyche_log_path):
        with open(psyche_log_path, "w") as f:
            f.write('{}')

    img1_path = os.path.join(img_dir, "multi_engine_test.png")
    img2_path = os.path.join(img_dir, "cat_01.jpg")

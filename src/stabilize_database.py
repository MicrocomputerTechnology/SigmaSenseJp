...
SOURCE_DB_PATH = os.path.join(config_dir, "sigma_product_database_custom_ai_generated.json")
STABILIZED_DB_PATH = os.path.join(config_dir, "sigma_product_database_stabilized.json")
ALPHA = 0.5 # 補正係数
